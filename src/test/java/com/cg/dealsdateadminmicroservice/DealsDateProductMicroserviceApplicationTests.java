...
import com.cg.dealsdateadminmicroservice.service.ProductServiceImpl;
...
class DealsDateProductMicroserviceApplicationTests {
	 ...
	 */
	@Test
	 void testSaveProduct_NullPointerException() {
	 ...
	 */
	@Test
	 void testSaveProduct_ProductAlreadyExist() {
	...
	/*
	 * @Test public void testOf1() { ProductEntity source = null; ProductModel
	 * result = service.of(source); assertEquals(source, result); }
	 * 
	 * @Test public void testOf2() { ProductModel source = null; ProductEntity
	 * result = service.of(source); assertEquals(source, result); }
	 */
	/*
	...
	void testSetProductName() {
		...
		ProductEntity entityProduct=new ProductEntity();
		entityProduct.setProductName(name);
		assertEquals(entityProduct.getProductName(),name);
	}
	...
	void testGetProductName() {
		...
		ProductEntity entityProduct=new ProductEntity();
		entityProduct.setProductName("Chocolate");
		String name="Chocolate";
		String result=entityProduct.getProductName();
	 ...
	 */
	@Test
	 void deleteProductTest_ProductNotExistWithNull() {
